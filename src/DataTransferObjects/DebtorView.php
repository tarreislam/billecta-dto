...
class DebtorView extends Data
{
	public function __construct(
		...
		public bool $UseProtectedMailDelivery,
		/** Format: date-time */
		 ...
		 * @var string|int|null
		 */
		public string|int|null $DebtorType = null,
		/**
		 * 0: ITELLA
		 * 1: TIETOSE
		 * 2: LOGICA
		 ...
		 * @var string|int|null
		 */
		public string|int|null $Intermediator = null,
		/**
		 * 0: OEB
		 * 1: SEB
		 * 2: SHB
		 ...
		 * @var string|int|null
		 */
		public string|int|null $EInvoiceBank = null,
